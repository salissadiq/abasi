...
const style = {
  ...
  default: `h-[98vh]  text-white top-0 mx-4 my-2 rounded-2xl lg:relative bg-[skyblue]  lg:block lg:z-40`,
};
    ...
    >
      <div className={style.container}>
        <button
          ...
          onClick={toggle}
          className="px-1 py-0 rounded-3xl bg-[skyblue] absolute bottom-0 -right-6 text-3xl text-white focus:outline-none text-center flex items-center justify-center"
        >
          <svg className={
            open
            ...
            <path d="M0.576172 0.200195H15.5377C23.8008 0.200195 30.4993 6.89871 30.4993 15.1617V15.1617C30.4993 23.4248 23.8008 30.1233 15.5377 30.1233H0.576172V0.200195Z" fill="skyblue" />
